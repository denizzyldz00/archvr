...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function fd(){return new zn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:sl(),fragmentShader:`
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function ud(){return new zn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:sl(),fragmentShader:`
	...
	`}function gg(a){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const c=o.mapping,l=c===$o||c===ec,d=c===fa||c===ua;if(l||d){let h=e.get(o);const f=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return t===null&&(t=new dd(a)),h=l?t.fromEquirectangular(o,h):t.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),h.texture;if(h!==void 0)return h.texture;{const u=o.image;return l&&u&&u.height>0||d&&u&&i(u)?(t===null&&(t=new dd(a)),h=l?t.fromEquirectangular(o):t.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),o.addEventListener("dispose",r),h.texture):null}}}return o}function i(o){let c=0;const l=6;for(let d=0;d<l;d++)o[d]!==void 0&&c++;return c===l}function r(o){const c=o.target;c.removeEventListener("dispose",r);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function s(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:s}}function xg(a){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=a.getExtension("WEBGL_depth_texture")||a.getExtension("MOZ_WEBGL_depth_texture")||a.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=a.getExtension("EXT_texture_filter_anisotropic")||a.getExtension("MOZ_EXT_texture_filter_anisotropic")||a.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=a.getExtension("WEBGL_compressed_texture_s3tc")||a.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||a.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=a.getExtension("WEBGL_compressed_texture_pvrtc")||a.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=a.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const i=t(n);return i===null&&Qa("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function _g(a,e,t,n){const i={},r=new WeakMap;function s(h){const f=h.target;f.index!==null&&e.remove(f.index);for(const b in f.attributes)e.remove(f.attributes[b]);for(const b in f.morphAttributes){const g=f.morphAttributes[b];for(let m=0,p=g.length;m<p;m++)e.remove(g[m])}f.removeEventListener("dispose",s),delete i[f.id];const u=r.get(f);u&&(e.remove(u),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(h,f){return i[f.id]===!0||(f.addEventListener("dispose",s),i[f.id]=!0,t.memory.geometries++),f}function c(h){const f=h.attributes;for(const b in f)e.update(f[b],a.ARRAY_BUFFER);const u=h.morphAttributes;for(const b in u){const g=u[b];for(let m=0,p=g.length;m<p;m++)e.update(g[m],a.ARRAY_BUFFER)}}function l(h){const f=[],u=h.index,b=h.attributes.position;let g=0;if(u!==null){const x=u.array;g=u.version;for(let y=0,_=x.length;y<_;y+=3){const M=x[y+0],A=x[y+1],S=x[y+2];f.push(M,A,A,S,S,M)}}else if(b!==void 0){const x=b.array;g=b.version;for(let y=0,_=x.length/3-1;y<_;y+=3){const M=y+0,A=y+1,S=y+2;f.push(M,A,A,S,S,M)}}else return;const m=new(ff(f)?gf:bf)(f,1);m.version=g;const p=r.get(h);p&&e.remove(p),r.set(h,m)}function d(h){const f=r.get(h);if(f){const u=h.index;u!==null&&f.version<u.version&&l(h)}else l(h);return r.get(h)}return{get:o,update:c,getWireframeAttribute:d}}function yg(a,e,t){let n;function i(f){n=f}let r,s;function o(f){r=f.type,s=f.bytesPerElement}function c(f,u){a.drawElements(n,u,r,f*s),t.update(u,n,1)}function l(f,u,b){b!==0&&(a.drawElementsInstanced(n,u,r,f*s,b),t.update(u,n,b))}function d(f,u,b){if(b===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,u,0,r,f,0,b);let m=0;for(let p=0;p<b;p++)m+=u[p];t.update(m,n,1)}function h(f,u,b,g){if(b===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<f.length;p++)l(f[p]/s,u[p],g[p]);else{m.multiDrawElementsInstancedWEBGL(n,u,0,r,f,0,g,0,b);let p=0;for(let x=0;x<b;x++)p+=u[x]*g[x];t.update(p,n,1)}}this.setMode=i,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=d,this.renderMultiDrawInstances=h}function vg(a){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,s,o){switch(t.calls++,s){case a.TRIANGLES:t.triangles+=o*(r/3);break;case a.LINES:t.lines+=o*(r/2);break;case a.LINE_STRIP:t.lines+=o*(r-1);break;case a.LINE_LOOP:t.lines+=o*r;break;case a.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",s);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function Mg(a,e,t){const n=new WeakMap,i=new qe;function r(s,o,c){const l=s.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=d!==void 0?d.length:0;let f=n.get(o);if(f===void 0||f.count!==h){let v=function(){w.dispose(),n.delete(o),o.removeEventListener("dispose",v)};var u=v;f!==void 0&&f.texture.dispose();const b=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],x=o.morphAttributes.normal||[],y=o.morphAttributes.color||[];let _=0;b===!0&&(_=1),g===!0&&(_=2),m===!0&&(_=3);let M=o.attributes.position.count*_,A=1;M>e.maxTextureSize&&(A=Math.ceil(M/e.maxTextureSize),M=e.maxTextureSize);const S=new Float32Array(M*A*4*h),w=new pf(S,M,A,h);w.type=Jt,w.needsUpdate=!0;const E=_*4;for(let C=0;C<h;C++){const D=p[C],L=x[C],k=y[C],O=M*A*4*C;for(let z=0;z<D.count;z++){const X=z*E;b===!0&&(i.fromBufferAttribute(D,z),S[O+X+0]=i.x,S[O+X+1]=i.y,S[O+X+2]=i.z,S[O+X+3]=0),g===!0&&(i.fromBufferAttribute(L,z),S[O+X+4]=i.x,S[O+X+5]=i.y,S[O+X+6]=i.z,S[O+X+7]=0),m===!0&&(i.fromBufferAttribute(k,z),S[O+X+8]=i.x,S[O+X+9]=i.y,S[O+X+10]=i.z,S[O+X+11]=k.itemSize===4?i.w:1)}}f={count:h,texture:w,size:new Ee(M,A)},n.set(o,f),o.addEventListener("dispose",v)}if(s.isInstancedMesh===!0&&s.morphTexture!==null)c.getUniforms().setValue(a,"morphTexture",s.morphTexture,t);else{let b=0;for(let m=0;m<l.length;m++)b+=l[m];const g=o.morphTargetsRelative?1:1-b;c.getUniforms().setValue(a,"morphTargetBaseInfluence",g),c.getUniforms().setValue(a,"morphTargetInfluences",l)}c.getUniforms().setValue(a,"morphTargetsTexture",f.texture,t),c.getUniforms().setValue(a,"morphTargetsTextureSize",f.size)}return{update:r}}function Sg(a,e,t,n){let i=new WeakMap;function r(c){const l=n.render.frame,d=c.geometry,h=e.get(c,d);if(i.get(h)!==l&&(e.update(h),i.set(h,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),i.get(c)!==l&&(t.update(c.instanceMatrix,a.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,a.ARRAY_BUFFER),i.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;i.get(f)!==l&&(f.update(),i.set(f,l))}return h}function s(){i=new WeakMap}function o(c){const l=c.target;l.removeEventListener("dispose",o),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:r,dispose:s}}class Mf extends bt{constructor(e,t,n,i,r,s,o,c,l,d=ca){if(d!==ca&&d!==ba)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&d===ca&&(n=li),n===void 0&&d===ba&&(n=ma),super(null,i,r,s,o,c,d,n,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Bt,this.minFilter=c!==void 0?c:Bt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Sf=new bt,pd=new Mf(1,1),Ef=new pf,Af=new lp,Tf=new yf,md=[],bd=[],gd=new Float32Array(16),xd=new Float32Array(9),_d=new Float32Array(4);function Aa(a,e,t){const n=a[0];if(n<=0||n>0)return a;const i=e*t;let r=md[i];if(r===void 0&&(r=new Float32Array(i),md[i]=r),e!==0){n.toArray(r,0);for(let s=1,o=0;s!==e;++s)o+=t,a[s].toArray(r,o)}return r}function xt(a,e){if(a.length!==e.length)return!1;for(let t=0,n=a.length;t<n;t++)if(a[t]!==e[t])return!1;return!0}function _t(a,e){for(let t=0,n=e.length;t<n;t++)a[t]=e[t]}function Us(a,e){let t=bd[e];t===void 0&&(t=new Int32Array(e),bd[e]=t);for(let n=0;n!==e;++n)t[n]=a.allocateTextureUnit();return t}function Eg(a,e){const t=this.cache;t[0]!==e&&(a.uniform1f(this.addr,e),t[0]=e)}function Ag(a,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(a.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;a.uniform2fv(this.addr,e),_t(t,e)}}function Tg(a,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(a.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(a.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(xt(t,e))return;a.uniform3fv(this.addr,e),_t(t,e)}}function wg(a,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(a.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;a.uniform4fv(this.addr,e),_t(t,e)}}function Rg(a,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;a.uniformMatrix2fv(this.addr,!1,e),_t(t,e)}else{if(xt(t,n))return;_d.set(n),a.uniformMatrix2fv(this.addr,!1,_d),_t(t,n)}}function Cg(a,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;a.uniformMatrix3fv(this.addr,!1,e),_t(t,e)}else{if(xt(t,n))return;xd.set(n),a.uniformMatrix3fv(this.addr,!1,xd),_t(t,n)}}function Ig(a,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;a.uniformMatrix4fv(this.addr,!1,e),_t(t,e)}else{if(xt(t,n))return;gd.set(n),a.uniformMatrix4fv(this.addr,!1,gd),_t(t,n)}}function Pg(a,e){const t=this.cache;t[0]!==e&&(a.uniform1i(this.addr,e),t[0]=e)}function Dg(a,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(a.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;a.uniform2iv(this.addr,e),_t(t,e)}}function Lg(a,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(a.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(xt(t,e))return;a.uniform3iv(this.addr,e),_t(t,e)}}function kg(a,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(a.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;a.uniform4iv(this.addr,e),_t(t,e)}}function Ug(a,e){const t=this.cache;t[0]!==e&&(a.uniform1ui(this.addr,e),t[0]=e)}function Ng(a,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(a.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;a.uniform2uiv(this.addr,e),_t(t,e)}}function Fg(a,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(a.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(xt(t,e))return;a.uniform3uiv(this.addr,e),_t(t,e)}}function Bg(a,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(a.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;a.uniform4uiv(this.addr,e),_t(t,e)}}function Og(a,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(a.uniform1i(this.addr,i),n[0]=i);let r;this.type===a.SAMPLER_2D_SHADOW?(pd.compareFunction=hf,r=pd):r=Sf,t.setTexture2D(e||r,i)}function Hg(a,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(a.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||Af,i)}function zg(a,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(a.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||Tf,i)}function jg(a,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(a.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||Ef,i)}function Gg(a){switch(a){case 5126:return Eg;case 35664:return Ag;case 35665:return Tg;case 35666:return wg;case 35674:return Rg;case 35675:return Cg;case 35676:return Ig;case 5124:case 35670:return Pg;case 35667:case 35671:return Dg;case 35668:case 35672:return Lg;case 35669:case 35673:return kg;case 5125:return Ug;case 36294:return Ng;case 36295:return Fg;case 36296:return Bg;case 35678:case 36198:case 36298:case 36306:case 35682:return Og;case 35679:case 36299:case 36307:return Hg;case 35680:case 36300:case 36308:case 36293:return zg;case 36289:case 36303:case 36311:case 36292:return jg}}function Vg(a,e){a.uniform1fv(this.addr,e)}function Wg(a,e){const t=Aa(e,this.size,2);a.uniform2fv(this.addr,t)}function qg(a,e){const t=Aa(e,this.size,3);a.uniform3fv(this.addr,t)}function Xg(a,e){const t=Aa(e,this.size,4);a.uniform4fv(this.addr,t)}function Kg(a,e){const t=Aa(e,this.size,4);a.uniformMatrix2fv(this.addr,!1,t)}function Yg(a,e){const t=Aa(e,this.size,9);a.uniformMatrix3fv(this.addr,!1,t)}function Jg(a,e){const t=Aa(e,this.size,16);a.uniformMatrix4fv(this.addr,!1,t)}function Zg(a,e){a.uniform1iv(this.addr,e)}function Qg(a,e){a.uniform2iv(this.addr,e)}function $g(a,e){a.uniform3iv(this.addr,e)}function ex(a,e){a.uniform4iv(this.addr,e)}function tx(a,e){a.uniform1uiv(this.addr,e)}function nx(a,e){a.uniform2uiv(this.addr,e)}function ix(a,e){a.uniform3uiv(this.addr,e)}function ax(a,e){a.uniform4uiv(this.addr,e)}function rx(a,e,t){const n=this.cache,i=e.length,r=Us(t,i);xt(n,r)||(a.uniform1iv(this.addr,r),_t(n,r));for(let s=0;s!==i;++s)t.setTexture2D(e[s]||Sf,r[s])}function sx(a,e,t){const n=this.cache,i=e.length,r=Us(t,i);xt(n,r)||(a.uniform1iv(this.addr,r),_t(n,r));for(let s=0;s!==i;++s)t.setTexture3D(e[s]||Af,r[s])}function ox(a,e,t){const n=this.cache,i=e.length,r=Us(t,i);xt(n,r)||(a.uniform1iv(this.addr,r),_t(n,r));for(let s=0;s!==i;++s)t.setTextureCube(e[s]||Tf,r[s])}function cx(a,e,t){const n=this.cache,i=e.length,r=Us(t,i);xt(n,r)||(a.uniform1iv(this.addr,r),_t(n,r));for(let s=0;s!==i;++s)t.setTexture2DArray(e[s]||Ef,r[s])}function lx(a){switch(a){case 5126:return Vg;case 35664:return Wg;case 35665:return qg;case 35666:return Xg;case 35674:return Kg;case 35675:return Yg;case 35676:return Jg;case 5124:case 35670:return Zg;case 35667:case 35671:return Qg;case 35668:case 35672:return $g;case 35669:case 35673:return ex;case 5125:return tx;case 36294:return nx;case 36295:return ix;case 36296:return ax;case 35678:case 36198:case 36298:case 36306:case 35682:return rx;case 35679:case 36299:case 36307:return sx;case 35680:case 36300:case 36308:case 36293:return ox;case 36289:case 36303:case 36311:case 36292:return cx}}class dx{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Gg(t.type)}}class hx{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=lx(t.type)}}class fx{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let r=0,s=i.length;r!==s;++r){const o=i[r];o.setValue(e,t[o.id],n)}}}const mo=/(\w+)(\])?(\[|\.)?/g;function yd(a,e){a.seq.push(e),a.map[e.id]=e}function ux(a,e,t){const n=a.name,i=n.length;for(mo.lastIndex=0;;){const r=mo.exec(n),s=mo.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&s+2===i){yd(t,l===void 0?new dx(o,a,e):new hx(o,a,e));break}else{let h=t.map[o];h===void 0&&(h=new fx(o),yd(t,h)),t=h}}}class vs{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const r=e.getActiveUniform(t,i),s=e.getUniformLocation(t,r.name);ux(r,s,this)}}setValue(e,t,n,i){const r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,s=t.length;r!==s;++r){const o=t[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,r=e.length;i!==r;++i){const s=e[i];s.id in t&&n.push(s)}return n}}function vd(a,e,t){const n=a.createShader(e);return a.shaderSource(n,t),a.compileShader(n),n}const px=37297;let mx=0;function bx(a,e){const t=a.split(`
`),n=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let s=i;s<r;s++){const o=s+1;n.push(`${o===e?">":" "} ${o}: ${t[s]}`)}return n.join(`
`)}const Md=new Le;function gx(a){Oe._getMatrix(Md,Oe.workingColorSpace,a);const e=`mat3( ${Md.elements.map(t=>t.toFixed(4))} )`;switch(Oe.getTransfer(a)){case Ls:return[e,"LinearTransferOETF"];case Qe:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",a),[e,"LinearTransferOETF"]}}function Sd(a,e,t){const n=a.getShaderParameter(e,a.COMPILE_STATUS),i=a.getShaderInfoLog(e).trim();if(n&&i==="")return"";const r=/ERROR: 0:(\d+)/.exec(i);if(r){const s=parseInt(r[1]);return t.toUpperCase()+`

`+i+`

`+bx(a.getShaderSource(e),s)}else return i}function xx(a,e){const t=gx(e);return[`vec4 ${a}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function _x(a,e){let t;switch(e){case _u:t="Linear";break;case yu:t="Reinhard";break;case vu:t="Cineon";break;case Mu:t="ACESFilmic";break;case Eu:t="AgX";break;case Au:t="Neutral";break;case Su:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+a+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Br=new P;function yx(){Oe.getLuminanceCoefficients(Br);const a=Br.x.toFixed(4),e=Br.y.toFixed(4),t=Br.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${a}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function vx(a){return[a.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",a.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter($a).join(`
`)}function Mx(a){const e=[];for(const t in a){const n=a[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Sx(a,e){const t={},n=a.getProgramParameter(e,a.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=a.getActiveAttrib(e,i),s=r.name;let o=1;r.type===a.FLOAT_MAT2&&(o=2),r.type===a.FLOAT_MAT3&&(o=3),r.type===a.FLOAT_MAT4&&(o=4),t[s]={type:r.type,location:a.getAttribLocation(e,s),locationSize:o}}return t}function $a(a){return a!==""}function Ed(a,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return a.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Ad(a,e){return a.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Ex=/^[ \t]*#include +<([\w\d./]+)>/gm;function Cc(a){return a.replace(Ex,Tx)}const Ax=new Map;function Tx(a,e){let t=Ue[e];if(t===void 0){const n=Ax.get(e);if(n!==void 0)t=Ue[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Cc(t)}const wx=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Td(a){return a.replace(wx,Rx)}function Rx(a,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function wd(a){let e=`precision ${a.precision} float;
...
#define LOW_PRECISION`),e}function Cx(a){let e="SHADOWMAP_TYPE_BASIC";return a.shadowMapType===Yh?e="SHADOWMAP_TYPE_PCF":a.shadowMapType===Qf?e="SHADOWMAP_TYPE_PCF_SOFT":a.shadowMapType===In&&(e="SHADOWMAP_TYPE_VSM"),e}function Ix(a){let e="ENVMAP_TYPE_CUBE";if(a.envMap)switch(a.envMapMode){case fa:case ua:e="ENVMAP_TYPE_CUBE";break;case Ps:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Px(a){let e="ENVMAP_MODE_REFLECTION";if(a.envMap)switch(a.envMapMode){case ua:e="ENVMAP_MODE_REFRACTION";break}return e}function Dx(a){let e="ENVMAP_BLENDING_NONE";if(a.envMap)switch(a.combine){case Jh:e="ENVMAP_BLENDING_MULTIPLY";break;case gu:e="ENVMAP_BLENDING_MIX";break;case xu:e="ENVMAP_BLENDING_ADD";break}return e}function Lx(a){const e=a.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function kx(a,e,t,n){const i=a.getContext(),r=t.defines;let s=t.vertexShader,o=t.fragmentShader;const c=Cx(t),l=Ix(t),d=Px(t),h=Dx(t),f=Lx(t),u=vx(t),b=Mx(r),g=i.createProgram();let m,p,x=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);const y=x+m+s,_=x+p+o,M=vd(i,i.VERTEX_SHADER,y),A=vd(i,i.FRAGMENT_SHADER,_);i.attachShader(g,M),i.attachShader(g,A),t.index0AttributeName!==void 0?i.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(g,0,"position"),i.linkProgram(g);function S(C){if(a.debug.checkShaderErrors){const D=i.getProgramInfoLog(g).trim(),L=i.getShaderInfoLog(M).trim(),k=i.getShaderInfoLog(A).trim();let O=!0,z=!0;if(i.getProgramParameter(g,i.LINK_STATUS)===!1)if(O=!1,typeof a.debug.onShaderError=="function")a.debug.onShaderError(i,g,M,A);else{const X=Sd(i,M,"vertex"),V=Sd(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(g,i.VALIDATE_STATUS)+`
